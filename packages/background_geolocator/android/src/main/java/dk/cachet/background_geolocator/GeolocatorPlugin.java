package dk.cachet.background_geolocator;

import dk.cachet.background_geolocator.tasks.Task;
import dk.cachet.background_geolocator.tasks.TaskFactory;
...
public class GeolocatorPlugin implements
  ...
  private static final String METHOD_CHANNEL_NAME = "flutter.baseflow.com/background_geolocator/methods";
  private static final String EVENT_CHANNEL_NAME = "flutter.baseflow.com/background_geolocator/events";
