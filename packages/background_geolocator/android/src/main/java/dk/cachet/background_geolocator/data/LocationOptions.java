package dk.cachet.background_geolocator.data;

import java.util.Map;

import static dk.cachet.background_geolocator.tasks.LocationUpdatesUsingLocationManagerTask.GeolocationAccuracy;
