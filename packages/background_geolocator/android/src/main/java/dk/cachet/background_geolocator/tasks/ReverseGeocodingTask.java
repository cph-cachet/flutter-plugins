...
import dk.cachet.background_geolocator.data.AddressMapper;
import dk.cachet.background_geolocator.data.Coordinate;
import dk.cachet.background_geolocator.data.wrapper.ChannelResponse;
import dk.cachet.background_geolocator.data.ReverseGeocodingOptions;

import java.io.IOException;
import java.util.List;
import java.util.Locale;

import dk.cachet.background_geolocator.utils.MainThreadDispatcher;
