  ...
  factory Geolocator() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel('flutter.baseflow.com/background_geolocator/methods');
      const EventChannel eventChannel =
          EventChannel('flutter.baseflow.com/background_geolocator/events');
