...
NSString *const METHOD_CHANNEL_NAME = @"flutter.baseflow.com/background_geolocator/methods";
NSString *const EVENT_CHANNEL_NAME = @"flutter.baseflow.com/background_geolocator/events";
