...
const _$HealthDataTypeEnumMap = {
  ...
  HealthDataType.CYCLING_PEDALING_CADENCE: 'CYCLING_PEDALING_CADENCE',
  ...
  HealthDataType.STEPS_CADENCE: 'STEPS_CADENCE',
  HealthDataType.WHEELCHAIR_PUSHES: 'WHEELCHAIR_PUSHES',
  HealthDataType.ACTIVITY_MOVE_MODE: 'ACTIVITY_MOVE_MODE',
  HealthDataType.FITZPATRICK_SKIN_TYPE: 'FITZPATRICK_SKIN_TYPE',
  HealthDataType.WHEELCHAIR_USE: 'WHEELCHAIR_USE',
  ...
  HealthDataType.INFREQUENT_MENSTRUAL_CYCLES: 'INFREQUENT_MENSTRUAL_CYCLES',
  HealthDataType.IRREGULAR_MENSTRUAL_CYCLES: 'IRREGULAR_MENSTRUAL_CYCLES',
  HealthDataType.PERSISTENT_INTERMENSTRUAL_BLEEDING:
      'PERSISTENT_INTERMENSTRUAL_BLEEDING',
  HealthDataType.PROLONGED_MENSTRUAL_PERIODS: 'PROLONGED_MENSTRUAL_PERIODS',
  HealthDataType.CERVICAL_MUCUS_QUALITY: 'CERVICAL_MUCUS_QUALITY',
  HealthDataType.OVULATION_TEST_RESULT: 'OVULATION_TEST_RESULT',
  HealthDataType.PROGESTERONE_TEST_RESULT: 'PROGESTERONE_TEST_RESULT',
  ...
  HealthDataType.RUNNING_GROUND_CONTACT: 'RUNNING_GROUND_CONTACT',
  ...
  HealthDataType.ENVIRONMENTAL_AUDIO_EXPOSURE_EVEN:
      'ENVIRONMENTAL_AUDIO_EXPOSURE_EVEN',
  HealthDataType.HEADPHONE_AUDIO_EXPOSURE_EVENT:
  ...
  HealthDataType.PEAK_EXPIRATORY_FLOW_RATE: 'PEAK_EXPIRATORY_FLOW_RATE',
  HealthDataType.APPLE_SLEEPING_WRIST_TEMPERATURE:
      'APPLE_SLEEPING_WRIST_TEMPERATURE',
  HealthDataType.TOOTHBRUSHING_EVENT: 'TOOTHBRUSHING_EVENT',
...
const _$HealthDataUnitEnumMap = {
  ...
  HealthDataUnit.VO2_MILLILITERS_PER_MINUTE_KILOGRAM:
  ...
  HealthDataUnit.OVULATION_TEST_RESULT: 'OVULATION_TEST_RESULT',
  HealthDataUnit.PROTECTION_USED: 'PROTECTION_USED',
  HealthDataUnit.RATE: 'RATE',
